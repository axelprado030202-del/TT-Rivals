/* TT Rivals 1.0.1 — Service Worker P7.4R.4.5
...
const TT_BUILD=params.get('v')||'v1.0.1-p7.4r.4.5-profile-card';
const CACHE_PREFIX='tt-rivals-';
const CACHE_NAME='tt-rivals-v1-0-1-p7-4r-4-5-profile-card';

/* TT Rivals 1.0.1 — Service Worker P7.4R.4.3
...
const TT_BUILD=params.get('v')||'v1.0.1-p7.4r.4.3-navigation-simplification';
const CACHE_PREFIX='tt-rivals-';
const CACHE_NAME='tt-rivals-v1-0-1-p7-4r-4-3-navigation-simplification';

const APP_SHELL=[
  './','./index.html','./manifest.webmanifest',
  './css/style.css','./css/v101_ui_rework.css','./css/v101_premium.css','./css/v101_motion_fx.css','./css/v70_metrics.css','./css/v71_result.css','./css/v72_progress.css','./css/v73_rematch.css','./css/v74_performance.css','./css/v74_rivalries.css','./css/v74_admin_decision.css','./css/v75_access_control.css','./css/v76_moderation_email.css','./css/v77_auto_moderation.css',

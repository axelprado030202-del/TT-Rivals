...
const TT_BUILD=params.get('v')||'60.0.0';
const CACHE_PREFIX='tt-rivals-';
const CACHE_NAME=`tt-rivals-v${TT_BUILD.replaceAll('.','-')}`;

const APP_SHELL=[
  './','./index.html','./css/style.css','./manifest.webmanifest',
  './js/version.js','./js/app.js','./js/pwa.js','./js/v60_runtime.js','./js/v60_presence.js','./js/v60_history.js',

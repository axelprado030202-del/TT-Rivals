/* TT Rivals 1.0.1 — Service Worker P7.3.3
...
const TT_BUILD=params.get('v')||'v1.0.1-p7.3.3-navigation-hotfix';
const CACHE_PREFIX='tt-rivals-';
const CACHE_NAME='tt-rivals-v1-0-1-p7-3-3-navigation-hotfix';

/* TT RIVALS V62.0.0 — el build llega desde js/version.js a través de ?v=. */
const params=new URL(self.location.href).searchParams;
const TT_BUILD=params.get('v')||'62.0.0';
const CACHE_PREFIX='tt-rivals-';
const CACHE_NAME=`tt-rivals-v${TT_BUILD.split('.').join('-')}`;

const APP_SHELL=[
  './','./index.html','./css/style.css','./manifest.webmanifest',
  './js/version.js','./js/app.js','./js/pwa.js','./js/v61_ai.js','./js/v62_doubles.js','./js/v60_runtime.js','./js/v60_motion.js','./js/v60_presence.js','./js/v60_history.js',

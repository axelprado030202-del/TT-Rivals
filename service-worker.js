...
const CACHE_NAME='tt-rivals-v1-0-1-ui2';

const APP_SHELL=[
  './','./index.html','./css/style.css','./css/v101_ui_rework.css','./manifest.webmanifest',
  './js/version.js','./js/app.js','./js/pwa.js','./js/v61_ai.js','./js/v62_doubles.js','./js/v63_integrity_rewards.js','./js/v100_launch.js','./js/v101_experience.js','./js/v60_runtime.js','./js/v60_motion.js','./js/v60_presence.js','./js/v60_history.js',

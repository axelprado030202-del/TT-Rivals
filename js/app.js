...
function populate(){
  ...
  const currentHomeRank=rankForRating(ind.rating);
  const homeRankIcon=$('#homeRankIcon');
  if(homeRankIcon){homeRankIcon.src=rankImagePath(currentHomeRank);homeRankIcon.alt=`Rango ${currentHomeRank}`;homeRankIcon.dataset.rank=currentHomeRank.toLowerCase();}

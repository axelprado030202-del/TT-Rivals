...
import {setupPwaV573,getPwaDiagnosticsV60,checkForUpdateV60} from './pwa.js?v=1.0.6';
import {APP_VERSION,APP_BUILD} from './version.js?v=1.0.6';
...
function ensureLeaguesUIV105(){
  if(!leaguesUIV105Promise)leaguesUIV105Promise=import('./leagues_v105.js?v=1.0.6').then(mod=>mod.createLeaguesUI({

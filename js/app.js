...
function activateTab(tab){
  ...
  if(tab==='profile'){renderAchievements();renderPrimaryRival();renderProfileSeasonCards();renderEquippedTitle();renderIdentityShowcase();ensureV63Module().then(mod=>mod.loadOwnPalmaresV63?.()).catch(()=>{});}

...
async function createChallenge(event){
  event.preventDefault();const user=await me();if(!user)return;
  ...
  setStatus('Desafío 2 vs 2 enviado ✓','ok');selected={teammate:null,opponent1:null,opponent2:null};activeSlot='teammate';updateSlots();event.currentTarget.reset();matchType='ranked';$$('[data-doubles-type-v62]').forEach(b=>b.classList.toggle('active',b.dataset.doublesTypeV62==='ranked'));await refresh();
}

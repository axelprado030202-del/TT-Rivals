...
function legalMetaHtml(config={}){
  const responsible=esc(config.responsible_name||'TT Rivals');
...
export function renderLegalDocumentV57(type,config={}){
  ...
  const body=terms?TERMS_HTML:PRIVACY_HTML;

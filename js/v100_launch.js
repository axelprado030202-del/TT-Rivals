...
async function submitPracticePlaceFormV100(e){
  e.preventDefault();const st=$('#practicePlaceFormStatusV100');const btn=e.currentTarget.querySelector('[type="submit"]');
  ...
  try{
    ...
    await rpc('submit_practice_place_v100',{p_payload:payload});e.currentTarget.reset();state.placeClub=null;setStatus(st,'✓ Lugar enviado. Quedó pendiente de aprobación.','ok');setTimeout(()=>{closePracticePlaceModalV100();loadPlacesV100()},800);
